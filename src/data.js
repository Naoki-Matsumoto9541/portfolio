...
import ATO_Platform from "./images/atoplatform.png";
import SIMPLE_SWAP from "./images/simple_swap.png";

export const projects = [
    
    {
        title: "ATO Platform",
        subtitle: "React.js, Node.js, MongoDB, Stripe API, KYC Verification Support, Smart Contract, Web3",
        description: "Artworks are guranteed by this site and Artist can get the profit from this site",
        image: ATO_Platform,
        link: "https://atoplatform.com",
        code: "",
    },
    {
        title: "SimpleSwap",
        subtitle: "React.js, Node.js, MongoDB, Smart Contract, Web3, Swagger",
        description: "User can convert from one crypto to another.",
        image: SIMPLE_SWAP,
